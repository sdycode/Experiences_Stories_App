...
class AnubhutiDetailsScreen extends StatefulWidget {
  int i;
  AnubhutiDetailsScreen({
    required this.i,
  });

  @override
  _AnubhutiDetailsScreenState createState() => _AnubhutiDetailsScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AnubhutiDetailsScreenState extends State<AnubhutiDetailsScreen> {
      ...
      body: Column(
        children: [
          ...
          Container(
            width: SCREEN_WIDTH,
            child: Text(
              providerItems.allItems.elementAt(widget.i - 1).title,
  ...
  Future _speak() async {
    ...
    print("Voices" + flutterTts.getVoices.toString());
    ...
    //     print("word " + i.toString() + " " + words.elementAt(i));
    //     print("progress " + flutterTts.progressHandler.toString());
    //   }
    //   flutterTts.setProgressHandler((text, start, end, word) {});
    // });
  }
