...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("वापरकर्त्याने अनुभव जोडले"),
      actions: [IconButton(onPressed: (){
            Navigator.push(context, MaterialPageRoute(builder: (ctx) =>  NewAdhyayScreen()));
                        ...
                        : ListView.builder(
                            itemBuilder: (ctx, i) {
                              return AdminListItem(
                                  i: i + 1,
                                  id: providerItems.sampleAllItems
                                      .elementAt(i)
                                      .getId,
                                  title: providerItems.sampleAllItems
                                      .elementAt(i)
                                      .getTitle);
                            },
