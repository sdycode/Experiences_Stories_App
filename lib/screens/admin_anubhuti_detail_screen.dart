...
class AdminAnubhutiDetailsScreen extends StatefulWidget {
  int i;
  AdminAnubhutiDetailsScreen({
    required this.i,
  });

  @override
  _AdminAnubhutiDetailsScreenState createState() => _AdminAnubhutiDetailsScreenState();
}

enum TtsState { playing, stopped, paused, continued }

class _AdminAnubhutiDetailsScreenState extends State<AdminAnubhutiDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String id = providerItems.sampleAllItems.elementAt(widget.i - 1).id;
    getAllDataFromId(id);
      ...
      body: Column(
        children: [
          ...
          Container(
            width: SCREEN_WIDTH,
            child: Text(
              providerItems.sampleAllItems.elementAt(widget.i - 1).title,
