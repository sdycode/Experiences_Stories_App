...
class AdminUpdatedListItem extends StatefulWidget {
  String title;
  String id;
  int i;
  AdminUpdatedListItem( {
    Key? key,
    required this.title,
    required this.id,
    required this.i,
  ...
  @override
  _AdminUpdatedListItemState createState() => _AdminUpdatedListItemState();
}

class _AdminUpdatedListItemState extends State<AdminUpdatedListItem> {
        ...
        child: Card(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                  onPressed: () {
                    if (providerItems.allItems.length > 1) {
                      deleteUpdatedAnubhuti(providerItems);
                    } else {
  ...
  Future<void> _addSampleToUpdated(Items providerItems) async {
    ...
    try {
      ...
      ListItemModel item = ListItemModel(
          id: backendId['name'], anubhutiId: anubhutiId, title: title, isUpdated: true);
      setState(() {
  ...
  Future<void> deleteUpdatedAnubhuti(Items providerItems) async {
    String url1 =
